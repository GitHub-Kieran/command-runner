...
public class CommandsController : ControllerBase
{
    ...
    public async Task<ActionResult<IterationExecutionResponse>> ExecuteIterativeCommand(CommandExecutionRequest request)
    {
        try
        {
            ...
            // Execute iteratively
            var progress = new Progress<IterationProgress>();
    ...
    public async Task<ActionResult<ValidationResult>> ValidateCommand(string profileId, string commandId)
    {
        try
        {
